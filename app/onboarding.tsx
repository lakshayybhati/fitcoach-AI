          ...
          <View style={styles.inputRow}>
            <View style={styles.inputHalf}>
              ...
              <View style={styles.timeChips}>
                {TRAINING_TIMES.slice(0, 4).map((time) => (
                  <TouchableOpacity
                    key={time}
                    style={[
                      styles.timeChip,
          ...
          <Animated.View style={[styles.fadeWrapper, { opacity: fadeAnim }]}>
            <Card style={styles.stepCard}>
              ...
              <View style={[
                ...
                step === 0 && !isSmallScreen && styles.firstStepButtonContainer,
                (step === 1 || step === 2) && styles.alignedButtonContainer
              ]}>
                {step > 0 && (
                  <Button
                    title="Back"
                    ...
                    variant="outline"
                    style={[styles.backButton, (step === 1 || step === 2) && styles.alignedButton]}
                  />
                )}
                <Button
                  title={step === steps.length - 1 ? "Build My Journey" : "Next"}
                  onPress={step === steps.length - 1 ? handleComplete : () => setStep(step + 1)}
                  style={[
                    styles.nextButton,
                    step === 0 && !isSmallScreen && styles.firstStepNextButton,
                    (step === 1 || step === 2) && styles.alignedButton
                  ]}
                />
              </View>
            </Card>
