...
import { Dumbbell, Apple, Heart, Sparkles, CheckCircle, Check, Camera } from 'lucide-react-native';
...
export default function PlanScreen() {
  ...
  const extraTotals = useMemo(() => {
    return todayExtras.reduce((totals, food) => ({
      ...
      <ScrollView style={styles.tabContent}>
        ...
        <View style={styles.mealsContainer}>
          {mealsData.map((meal, index) => {
            ...
            return (
              <Card key={meal.name} style={[styles.mealCard, isCompleted && styles.completedMealCard]}>
              ...
              <View style={styles.snapFoodTextContainer}>
                ...
                <Text style={styles.snapFoodSubtitle}>
                  {todayExtras.length === 0 
                    ...
                    : `${todayExtras.length} snap${todayExtras.length > 1 ? 's' : ''} added`
                  }
                </Text>
              </View>
            </View>
    ...
    <ScrollView style={styles.tabContent}>
      ...
      <Card style={styles.actionCard}>
        ...
        <View style={styles.actionButtons}>
          ...
          <Button
            title="Log Progress"
            onPress={() => {/* TODO: Implement progress logging */}}
            variant="outline"
            style={styles.actionButton}
          />
        </View>
